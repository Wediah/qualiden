                            ...
                            <div class="border border-gray-200 p-6 flex flex-col h-full">
                                ...
                                <form id="contact-form" class="flex-1 flex flex-col">
                                    ...
                                    <div class="mb-6">
                                        ...
                                        >
                                        <div class="text-right text-xs text-gray-400 mt-1">
                                            <span id="company-count">0</span>/200
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-6">
                                        ...
                                        <div class="flex gap-2">
                                            ...
                                            <input
                                                ...
                                                class="flex-1 px-4 py-3 border border-gray-300 rounded focus:outline-none focus:border-[#fbbf24] transition-colors"
                                                required
                                            >
                                        </div>
                                        <div class="text-right text-xs text-gray-400 mt-1">
                                            <span id="whatsapp-count">0</span>/100
                                        </div>
                                    </div>
