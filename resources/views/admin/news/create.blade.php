...
<x-layouts::app :title="__('Create New Article')">
    <div class="min-h-screen bg-gray-900 py-8 px-4 sm:px-6 lg:px-8">
        <div class="max-w-5xl mx-auto">
            <!-- Header -->
            <div class="mb-8">
                <h1 class="text-3xl font-bold text-gray-100 mb-2">Create New Article</h1>
                <p class="text-gray-400">Fill in the details below to create a new news article</p>
            </div>
                ...
                <form method="POST" action="{{ route('admin.news.store') }}" enctype="multipart/form-data">
                            ...
                            <div class="space-y-6">
                                ...
                                <div class="space-y-2">
                                    ...
                                    <input type="text" id="tags" name="tags" value="{{ old('tags') }}"
                                           ...
                                           class="w-full rounded-lg border border-gray-600 bg-gray-700 px-4 py-3 text-sm text-white placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-[#fbbf24] focus:border-transparent transition">
                                    <p class="text-xs text-gray-400">Separate tags with commas (e.g., technology, business, news)</p>
                                </div>
                                ...
                                <div class="bg-gray-700/50 rounded-lg p-4">
                                    <div class="flex items-start gap-3">
                                        ...
                                        <div class="flex-1">
                                            ...
                                            <p class="text-xs text-gray-400 mt-1">Your article will be accessible at:</p>
                                            <p class="text-sm text-[#fbbf24] font-mono mt-1" id="slugPreview">/news/your-article-slug</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="px-8 py-6 bg-gray-900/50 border-t border-gray-700">
                        <div class="flex flex-col sm:flex-row justify-between items-center gap-4">
                            <a href="{{ route('admin.news.index') }}" class="inline-flex items-center justify-center gap-2 px-5 py-2.5 text-sm font-medium text-gray-300 hover:text-white bg-gray-800 border border-gray-600 rounded-lg hover:bg-gray-700 transition-colors w-full sm:w-auto">
            ...
            function updateSlugPreview() {
                ...
                if (title) {
                    const slug = title.toLowerCase()
                        ...
                        .replace(/--+/g, '-')
                        .trim();
                    slugPreview.textContent = `/news/${slug}`;
                } else {
                    slugPreview.textContent = '/news/your-article-slug';
                }
            }
