<x-layouts::app :title="__('Edit Project')">
    <div class="min-h-screen bg-gray-900 py-8 px-4 sm:px-6 lg:px-8">
        <div class="max-w-5xl mx-auto">
            <!-- Header -->
            <div class="mb-8">
                <h1 class="text-3xl font-bold text-gray-100 mb-2">Edit Project</h1>
                <p class="text-gray-600 dark:text-gray-400">Update your project details below</p>
            </div>

            <!-- Main Card -->
            <div class="dark:bg-gray-800 rounded-xl shadow-lg overflow-hidden border  dark:border-gray-700">
                <form method="POST" action="{{ route('projects.update', $project) }}" enctype="multipart/form-data" class="p-0">
                    @csrf
                    @method('PUT')
                    ...
                    @if (session('message'))
                        <div class="m-6 mb-0">
                            <div role="alert" class="relative w-full rounded-lg border p-4 border-green-600 bg-green-900/20 text-green-800 dark:text-green-400">
...
{{--                                            </svg>--}}
                                        ...
                                        <input
                                            ...
                                            required
                                            class="pl-10 w-full rounded-lg border border-gray-600 bg-gray-700 px-4 py-3 text-sm placeholder:text-gray-500 dark:placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-[#fbbf24] focus:border-transparent transition"
                                        >
                                    </div>
                                    @error('name')
...
{{--                                                    </svg>--}}
                                    ...
                                    @if($project->images->isNotEmpty())
                                        <div class="mt-4">
                                            <h4 class="text-sm font-medium text-gray-300 mb-3">Current Images</h4>
                                            <div class="grid grid-cols-3 sm:grid-cols-4 gap-3">
                                                @foreach($project->images as $image)
                                                    <div class="relative group rounded-lg overflow-hidden border border-gray-700 bg-gray-100 dark:bg-gray-900">
                                                        <img
                                    ...
                                    <!-- New Images Preview -->
                                    <div class="mt-4">
                                        <h4 class="text-sm font-medium text-gray-300 mb-3">New Images</h4>
                                ...
                                <!-- Tips Section -->
                                <div class="bg-amber-900/10 border border-amber-200 dark:border-amber-800 rounded-lg p-4">
                                    <div class="flex">
                                        <div class="shrink-0">
                    ...
                    <div class="px-8 py-6 bg-gray-900/50 border-t border-gray-700">
                        <div class="flex flex-col sm:flex-row justify-between items-center gap-4">
                            <a href="{{ route('dashboard') }}" class="inline-flex items-center justify-center gap-2 px-5 py-2.5 text-sm font-medium text-gray-300 hover:text-white bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-lg hover:bg-gray-700 transition-colors w-full sm:w-auto">
