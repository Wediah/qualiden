<x-layouts::app :title="__('Create New Project')">
    <div class="min-h-screen bg-gray-900 py-8 px-4 sm:px-6 lg:px-8">
        <div class="max-w-5xl mx-auto">
            <!-- Header -->
            <div class="mb-8">
                <h1 class="text-3xl font-bold text-gray-100 mb-2">Create New Project</h1>
                <p class="text-gray-400">Fill in the details below to create a new project</p>
            </div>
...
{{--                                                    </svg>--}}
                                ...
                                <!-- Tips Section -->
                                <div class="bg-amber-900/10 border border-amber-800 rounded-lg p-4">
                                    <div class="flex">
                                        <div class="shrink-0">
                                        ...
                                        <div class="ml-3">
                                            <h3 class="text-sm font-medium text-amber-300">Tips</h3>
