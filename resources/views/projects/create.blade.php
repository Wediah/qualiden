                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="space-y-3">
                            ...
                            <div id="selectedGrid" class="mt-4 grid grid-cols-3 sm:grid-cols-4 gap-2"></div>
                ...
                input.addEventListener('change', function (e) {
                    ...
                    files.forEach((file, idx) => {
                        ...
                        reader.onload = function (ev) {
                            ...
                            wrapper.className = 'relative group aspect-square rounded-md overflow-hidden border border-gray-200 dark:border-gray-600';
                            ...
                            btn.type = 'button';
                            btn.className = 'absolute top-1 right-1 bg-red-600 text-white rounded-full p-1 opacity-0 group-hover:opacity-100 transition-opacity focus:outline-none focus:ring-2 focus:ring-red-500';
                            ...
                            btn.addEventListener('click', function () {
                                ...
                                // Re-trigger change to refresh previews
