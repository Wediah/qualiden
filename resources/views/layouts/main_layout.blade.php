...
<nav id="navbar" class="absolute top-0 w-full z-50 bg-transparent text-black py-4 px-4 md:px-14">
    <div class="flex flex-wrap items-center justify-between mx-auto">
        ...
        <!-- Mobile menu button -->
        <button id="menu-toggle" type="button" class="inline-flex items-center p-2 w-10 h-10 justify-center text-sm bg-[#fbbf24] text-black rounded-lg border border-black md:hidden hover:bg-amber-400 focus:outline-none focus:ring-2 focus:ring-[#fbbf24]">
        ...
        <div class="flex justify-between flex-col items-center md:flex-row gap-6">
            <div>
                <ul class="flex flex-row gap-6 text-gray-200 text-sm">
                    ...
                    <li><a href="/policy" class="hover:text-[#fbbf24] transition-colors">Our company policy</a></li>
